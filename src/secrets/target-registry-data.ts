...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.discord.accounts.*.voice.tts.inworld.apiKey",
    targetType: "channels.discord.accounts.*.voice.tts.inworld.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.discord.accounts.*.voice.tts.inworld.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.discord.voice.tts.inworld.apiKey",
    targetType: "channels.discord.voice.tts.inworld.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.discord.voice.tts.inworld.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
